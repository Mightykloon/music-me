    ...
    <div className={className}>
      ...
      <div className="flex items-start gap-5">
        <Avatar
          ...
          size="2xl"
          className="ring-4 ring-[var(--profile-primary)]/20"
        />
          ...
          <div className="mt-3">
            {isOwn ? (
              <a
                ...
                className="inline-flex items-center justify-center h-8 px-3 text-sm font-medium rounded-lg border border-border hover:bg-muted transition-colors"
              >
                Edit profile
              </a>
            ) : (
      ...
      {/* Bio */}
      {user.bio && (
        <p className={`mt-4 ${bioSizeClass} whitespace-pre-wrap break-words`}>
          {user.bio}
        </p>
      )}
      ...
      <div className="mt-3 flex items-center gap-4 text-sm text-muted-foreground flex-wrap">
        ...
        {user.website && (
          <a
            ...
            className="flex items-center gap-1 text-[var(--profile-primary)] hover:underline"
          >
      ...
      <div className="mt-4 flex items-center gap-6 text-sm">
        ...
        <button className="hover:underline">
          ...
          <span className="text-muted-foreground">Tuned In</span>
        </button>
        <span>
          <span className="font-semibold">{formatCount(user._count.posts)}</span>{" "}
